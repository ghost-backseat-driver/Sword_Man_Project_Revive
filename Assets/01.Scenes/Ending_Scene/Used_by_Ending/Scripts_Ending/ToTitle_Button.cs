...
public class ToTitle_Button : MonoBehaviour
{
    [SerializeField] private string targetScene = "Title_Scene";
    ...
    {
        //버튼 이벤트 등록
        sceneChangeButton.onClick.AddListener(ToTitle);
    }

    //중복방지
    private void OnDestroy()
    {
        sceneChangeButton.onClick.RemoveListener(ToTitle);
    }
